...
/* 
 * My experiment codes and their description (not for submitting)
 */
...
/* 
 * Submmited function for M = 32, N = 32
 */
void trans_32x32(int M, int N, int A[N][M], int B[M][N])
{
    int bsize = 8;
...
/* 
 * Submmited function for M = 64, N = 64
 */
void trans_64x64(int M, int N, int A[N][M], int B[M][N])
{
    int bsize = 8;
...
/* 
 * Submmited function for M = 61, N = 67
 */
void trans_61x67(int M, int N, int A[N][M], int B[M][N])
{
    int bsize = 8;
